...
\include "/home/georg/Dokumente/Quintett/+lilypond/Lopez_Duo/Duo.ly"
...
%         }
        \new Staff{\set Staff.instrumentName = "Kl. 1"
            \set Staff.midiInstrument = #"Clarinet" << \globalDuo \DuoEins  >>
        }
        \new Staff{\set Staff.instrumentName = "Kl. 2"
            \set Staff.midiInstrument = #"Clarinet" << \globalBass \transpose c c,\DuoBass  >>
        }
    >>
    \layout {
        \context {
