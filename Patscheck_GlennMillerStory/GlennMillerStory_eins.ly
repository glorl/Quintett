...
\partial 4 
\tuplet 3/2 {g8^\markup{American Patrol} (a b}
c4-.) c-. c8 (b c d) 
e8-- e4-. e8 (~e d e f) 
g4-. g8 (fis g fis g c) 
g2 r8 dis8 (e4-.) 
...
R1*2^\markup{Moderato}
g8---> \ff g-.-^ r4 r4 g,8---> g-.-^
r2 g8---> g-.-^ r4 
r4 g,8---> g-.-^ r8 g''8(\noBeam \tuplet 3/2 { a8) [r ais](}
b4 a g f) \bar"||"
e,4.--^\markup{A String of Pearls}\mp e8 ~e4 e4-- 
~e8 e4.-- e8 (f g-.) r
e4.-- e8 ~e4 e4-- 
~e8 e4.-- e8 (f g-.) r
e4.-- e8 ~e4 e4-- 
...
r8 ^\markup{Slow} e4 (c8 e4.  c8 
e8^\markup{A Sentimental Journey} c e c e c4.)
r8 e4 (c8 e4. f8 
e4 es8 d ~d2)
r8 e4 (c8 e4. c8 
es8 c es c es d4.)
