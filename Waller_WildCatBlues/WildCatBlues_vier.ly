...
a4 (as8 g ~g2) 
g8 ( a c e g dis e) a->
( ~a^\markup { \fontsize #4 {\musicglyph #"scripts.coda" }} dis, e-- c) r2 \bar"||"
c2_\markup{\dynamic p} ~c4 r
a4. c8 ~c8 c8-- c4-.
e4-. g, ~g2
c4. bes8 ~bes8 (e) g4-.
f2 (d) 
...
\tuplet 3/2 {e,8 \< (es d} \tuplet 3/2 {des c b} \tuplet 3/2 {bes8 a as} \tuplet 3/2 {g8 ges f)}
e4-.\!\ff r4 r2
r1
c'4 r a r 
b4 r r8 ais-- b4-.
